...
/**
 * The second introduction screen of the game.
 * <p>
 *     This screen will show how to control the snake,
 *     and how to pause and restart the game.
 *
 * @author <a href = "scyyz17@nottingham.ac.uk">Yunchi Zhao</a>
 * @since master
 */
public class Introduction2_controller extends Application {
     ...
     * @param actionEvent   Go to next page if click the next button
     */
    public void gotoIntroduction3(ActionEvent actionEvent) {
        Stage stage = (Stage)next.getScene().getWindow();
        ViewAlter.GotoIntroduction_3(stage);
    }
}
